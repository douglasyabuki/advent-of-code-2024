export const day = {
  ...
  stars: 2,
  story: `Fortunately, the first location The Historians want to search isn't a long walk from the Chief Historian's office.
...
Analyze the unusual data from the engineers. How many reports are safe?`,
  firstStarFunction: (input: string): number => {
    ...
    input.split("\n").forEach((line) => {
      ...
      const isIncreasing = digits[0] < digits[1];
      let safe = true;
